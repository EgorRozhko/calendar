<?php
	...
	$search_string = 'SELECT events.id,events.title,place_id,map_image,coords FROM places INNER JOIN events ON events.place_id = places.id_place WHERE events.metadata LIKE "%'.$search_text.'%"';
